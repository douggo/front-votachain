...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Out-2018 às 20:06
...
--
-- Estrutura da tabela `usuario_eleicao`
--

CREATE TABLE `usuario_eleicao` (
  `id` int(11) NOT NULL,
...
--
-- Extraindo dados da tabela `usuario_eleicao`
--

INSERT INTO `usuario_eleicao` (`id`, `id_usuario`, `id_eleicao`) VALUES
(3, 1, 1),
(4, 2, 1);
...
INSERT INTO `votos` (`id`, `id_candidato_eleicao`) VALUES
(2, 1),
(3, 1);
...
--
-- Indexes for table `usuario_eleicao`
--
ALTER TABLE `usuario_eleicao`
  ADD PRIMARY KEY (`id`),
  ADD KEY `usuario_id` (`id_usuario`),
  ADD KEY `eleicao_id` (`id_eleicao`);
...
--
-- AUTO_INCREMENT for table `usuario_eleicao`
--
ALTER TABLE `usuario_eleicao`
...
--
-- Limitadores para a tabela `usuario_eleicao`
--
ALTER TABLE `usuario_eleicao`
  ADD CONSTRAINT `eleicao_id` FOREIGN KEY (`id_eleicao`) REFERENCES `eleicoes` (`id`),
